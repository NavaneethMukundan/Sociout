...
class JobSearchResultWidget extends StatelessWidget {
  const JobSearchResultWidget({super.key});

  @override
  Widget build(
    BuildContext context,
  ) {
    final provider = Provider.of<JobSearchController>(
      context,
      listen: false,
    );
    return SizedBox(
            ...
            children: [
              ...
              Row(
                children: [
                  ...
                  const Expanded(
                    child: Text(
                      " provider.searchResponse[index].designation.toString()",
                      maxLines: 1,
